...
AND (rt.role in ('actress','cinematographer','costume designer','director','miscellaneous crew','producer','production designer'))
AND (n.gender in ('f') OR n.gender IS NULL)
AND (n.surname_pcode in ('B42','B624','H2','J52','L2','M6','R2','S53') OR n.surname_pcode IS NULL)
