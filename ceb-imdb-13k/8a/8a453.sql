...
AND (it1.id IN ('5'))
AND (mi1.info in ('Australia:PG','Canada:PG','Singapore:PG','UK:PG'))
AND (kt.kind in ('episode','movie'))
AND (rt.role in ('actor','director','producer'))
AND (n.gender in ('m'))
AND (n.name_pcode_cf in ('A4361','B6525','B6535','C6325','G6262','L5352','M6256','P6252','R1525','R2632','S4153','W4525'))
