...
AND (it1.id IN ('7'))
AND (mi1.info in ('PCS:Kinescope','PCS:Spherical','PFM:35 mm','RAT:1.33 : 1','RAT:1.78 : 1','RAT:1.85 : 1','RAT:16:9 HD','RAT:2.35 : 1'))
...
AND (n.surname_pcode in ('B4','B62','D5','G6','J52','J525','L15','L52','P62','R3','S5','T521','W425'))
