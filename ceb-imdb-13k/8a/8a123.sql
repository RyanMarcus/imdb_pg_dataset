...
AND (it1.id IN ('7'))
AND (mi1.info in ('CAM:Panavision Cameras and Lenses','LAB:Technicolor','LAB:Technicolor, Hollywood (CA), USA','MET:','OFM:35 mm','PCS:Super 35','PFM:35 mm','PFM:70 mm','RAT:1.33 : 1','RAT:1.78 : 1'))
