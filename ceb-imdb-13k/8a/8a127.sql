...
AND (it1.id IN ('7'))
AND (mi1.info in ('LAB:DeLuxe','PCS:Kinescope','PCS:Spherical','PFM:35 mm','RAT:1.78 : 1','RAT:1.85 : 1','RAT:2.35 : 1'))
AND (kt.kind in ('episode','movie','tv series'))
AND (rt.role in ('actor','actress','director'))
AND (n.gender in ('f','m'))
AND (n.name_pcode_cf in ('A4361','A5362','B6525','B6526','M6256','P3625','P6252','R1525','R2632','S4153','W4525'))
