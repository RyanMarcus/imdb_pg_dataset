...
AND (it1.id IN ('3'))
AND (mi1.info in ('Adventure','Animation','Documentary','Drama','Family','Fantasy','Music','Mystery','Sci-Fi','Short'))
AND (kt.kind in ('episode','movie','tv movie','tv series'))
AND (rt.role in ('actor'))
AND (n.gender in ('m'))
AND (n.name_pcode_cf in ('A5362','B4525','B6526','M6352','P6252','R1632','R2632','R363','S3152','S5362'))
