...
AND (n.gender in ('f','m'))
AND (n.surname_pcode in ('J52','J525','L2','L52','M2','W452') OR n.surname_pcode IS NULL)
AND (t.production_year <= 1975)
AND (t.production_year >= 1875)
AND (cn.name in ('American Broadcasting Company (ABC)','General Film Company','Pathé Frères','Universal Film Manufacturing Company'))
