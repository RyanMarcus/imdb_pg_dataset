...
AND (mi1.info IN ('Adventure','Biography','Buenos Aires, Federal District, Argentina','History','Music','Musical','Mystery','New York City, New York, USA','Sci-Fi','Sport','War'))
AND (it1.id IN ('15','18','3'))
AND it3.id = '100'
AND it4.id = '101'
