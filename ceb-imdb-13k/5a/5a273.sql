...
AND (mi1.info IN ('Biography','Denmark','Fantasy','History','Hong Kong','Mexico','Musical','Mystery','Netherlands','Portugal','Sweden','War','West Germany','Western'))
AND (it1.id IN ('16','3','8'))
AND it3.id = '100'
AND it4.id = '101'
