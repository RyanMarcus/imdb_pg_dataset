...
AND (mi1.info IN ('Argentina:13','Australia:G','Mexico','Netherlands:12','RAT:1.66 : 1','RAT:1.78 : 1 / (high definition)','Singapore:PG','UK:15','UK:18','USA:Not Rated','USA:TV-14'))
AND (it1.id IN ('18','5','7'))
AND it3.id = '100'
AND it4.id = '101'
