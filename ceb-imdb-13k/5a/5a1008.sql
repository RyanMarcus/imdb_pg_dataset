...
AND (mi1.info IN ('Argentina:Atp','Australia:M','Dutch','English','French','German','Italian','Japanese','Los Angeles, California, USA','New York City, New York, USA','UK:15','USA:R'))
AND (it1.id IN ('18','4','5'))
AND it3.id = '100'
AND it4.id = '101'
