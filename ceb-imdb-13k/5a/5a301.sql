...
AND (mi1.info IN ('Adventure','Biography','Fantasy','History','Music','Mystery','PCS:Digital Intermediate','PFM:Video','RAT:1.66 : 1','RAT:1.78 : 1 / (high definition)','Sci-Fi','Sport','War','Western'))
AND (it1.id IN ('3','7'))
AND it3.id = '100'
AND it4.id = '101'
