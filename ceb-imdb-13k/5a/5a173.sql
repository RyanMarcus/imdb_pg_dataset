...
AND (mi1.info IN ('Argentina:13','Australia:M','Greek','Netherlands:12','OFM:16 mm','PCS:Digital Intermediate','Portugal:M/12','RAT:1.78 : 1 / (high definition)','Russian','UK:15','UK:18','USA:Not Rated','USA:TV-14'))
AND (it1.id IN ('4','5','7'))
AND it3.id = '100'
AND it4.id = '101'
