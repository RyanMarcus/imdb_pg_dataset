...
AND (mi1.info IN ('Argentina','Australia','Brazil','Canada','France','Germany','India','Italy','Japan','Los Angeles, California, USA','Mexico','New York City, New York, USA','Spain','UK','USA'))
AND (it1.id IN ('18','8'))
AND it3.id = '100'
AND it4.id = '101'
