...
AND (mi1.info IN ('Comedy','Documentary','Drama','OFM:35 mm','PCS:Spherical','PFM:35 mm','Romance','Short'))
AND (it1.id IN ('3','7'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A4163','A5362','E6523','F6521','F6525','M6263','R1632') OR n.name_pcode_nf IS NULL)
