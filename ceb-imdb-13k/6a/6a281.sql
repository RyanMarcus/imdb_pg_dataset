...
AND (mi1.info IN ('Action','Adventure','Animation','Comedy','Crime','Documentary','Dolby Digital','Mono','Short','Stereo','Thriller'))
AND (it1.id IN ('3','6','97'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('D135','D5463','F6525','H252','J5136','J5152','L6252','M2123','M2426','N242','S6256'))
