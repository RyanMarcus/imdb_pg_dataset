...
AND (mi1.info IN ('Adult','Adventure','Animation','Family','Horror','Musical','Thriller'))
AND (it1.id IN ('3'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('f'))
AND (n.name_pcode_nf in ('A4253','A5242','B6165','J3261','J5162','M6232','M6242','M6252','P3625','S2525'))
AND (ci.note IS NULL)
