...
AND (mi1.info IN ('30','60','France','Italy','Japan','UK','USA','West Germany'))
AND (it1.id IN ('1','8'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('f','m'))
AND (n.name_pcode_nf in ('A4152','A4253','B6165','C6452','D1324','E3631','F6521','J5163','J5214','J5243','K5252','M2424','M2453','W4516'))
AND (ci.note IS NULL)
