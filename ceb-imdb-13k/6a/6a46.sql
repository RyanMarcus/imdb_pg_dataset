...
AND (mi1.info IN ('Canada','Denmark','Mexico','Philippines','Soviet Union','Turkey','West Germany'))
AND (it1.id IN ('8','94'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('f','m'))
AND (n.name_pcode_nf in ('B6563','C6426','E3632','E4213','F6362','F6523','F6524','F6532','G6216','R1635','R2632','S2534','V4356','W4362'))
