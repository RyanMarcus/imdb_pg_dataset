...
AND (mi1.info IN ('Denmark','Mexico','Philippines','Soviet Union','Turkey','West Germany','Yugoslavia'))
AND (it1.id IN ('8','94'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A4163','A6362','B6563','E3632','E4213','F4652','F6362','F6524','F6526','F6532','G6216','H6163','R1635','R2632','W4362'))
