...
AND (mi1.info IN ('Canada','France','India','Italy','Japan','UK','West Germany'))
AND (it1.id IN ('16','8','98'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('C6235','C6416','C6452','D5162','E4213','J5215','M6216','M6263','R3565') OR n.name_pcode_nf IS NULL)
AND (ci.note IS NULL)
