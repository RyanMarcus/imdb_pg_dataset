...
AND (mi1.info IN ('Austria','Czechoslovakia','Denmark','Finland','Hungary','Ireland','Poland','Portugal','Soviet Union','Sweden','Switzerland','Turkey','Yugoslavia'))
AND (it1.id IN ('13','8'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A5123','B3621','C6542','D5142','G1643','G6212','H4562','I5216','J6362','M2465','M6365','M6542','R246','S2542'))
