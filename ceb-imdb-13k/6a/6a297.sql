...
AND (mi1.info IN ('Comedy','Crime','Documentary','Drama','Romance','Short','Western'))
AND (it1.id IN ('13','3'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A4253','A5352','A5362','C6423','C6424','C6425','C6426','E6523','F6524','F6525','R1632'))
