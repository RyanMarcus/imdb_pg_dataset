...
AND (mi1.info IN ('Mono','PFM:Video','RAT:1.33 : 1','Stereo'))
AND (it1.id IN ('12','6','7'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('D1316','F6521','J5252','M2425','P3625','S3151') OR n.name_pcode_nf IS NULL)
AND (ci.note IS NULL)
