...
AND (mi1.info IN ('10','12','15','30','5','60','7','9','90','Argentina:60'))
AND (it1.id IN ('1','108','98'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('m'))
AND (n.name_pcode_nf in ('B6512','B6521','D5215','D5431','J2425','J532','R1632','S2153','S3631','T5163'))
