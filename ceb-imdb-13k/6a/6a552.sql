...
AND (mi1.info IN ('Adventure','Family','Filipino','Germany','Hindi','Mexico','Musical','Philippines','Soviet Union','Spain','Tagalog','Thriller','Turkey','Turkish','War','West Germany','Western','Yugoslavia'))
AND (it1.id IN ('3','4','8'))
AND it3.id = '100'
AND it4.id = '101'
