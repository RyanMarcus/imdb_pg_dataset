...
AND (mi1.info IN ('Adult','Adventure','Biography','History','Music','Musical','Mystery','Sci-Fi','Western'))
AND (it1.id IN ('17','3'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('f','m'))
AND (n.name_pcode_nf in ('G1642','J1626','J2452','J52','K25','K6231','M625','P3624','P3652','R3412','S3152','T5352','W4562'))
