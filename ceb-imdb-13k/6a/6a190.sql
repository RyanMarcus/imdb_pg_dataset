...
AND (mi1.info IN ('Animation','Comedy','Crime','Documentary','Short','Western'))
AND (it1.id IN ('103','3','94'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A4253','A5352','A5362','C6421','C6423','C6424','C6426','E6523','F6524','F6525','R1631','R1632') OR n.name_pcode_nf IS NULL)
