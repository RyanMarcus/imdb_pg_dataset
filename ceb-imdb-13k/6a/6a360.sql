...
AND (mi1.info IN ('Germany','Mexico','Soviet Union','Turkey','West Germany','Yugoslavia'))
AND (it1.id IN ('15','17','8'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('m'))
AND (n.name_pcode_nf in ('C6421','C6424','C6426','F6524','F6532','R1631','R2632','V4356','W4362'))
