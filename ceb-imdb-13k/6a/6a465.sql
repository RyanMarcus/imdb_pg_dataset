...
AND (mi1.info IN ('90','Dolby Digital'))
AND (it1.id IN ('1','104','6'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A5352','A5362','B6535','C6231','C6235','F6521','F6525','R1631','R1632','R2632','S3152') OR n.name_pcode_nf IS NULL)
AND (ci.note IS NULL)
