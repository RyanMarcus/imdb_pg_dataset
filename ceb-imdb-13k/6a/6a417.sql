...
AND (mi1.info IN ('Animation','Documentary','Drama','Music','Short','Thriller'))
AND (it1.id IN ('15','16','3'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('f','m'))
AND (n.name_pcode_nf in ('A4163','A4253','A5362','B6535','C6231','C6235','E4213','F6521','F6525','K6235','R1632','R2632','S3152') OR n.name_pcode_nf IS NULL)
AND (ci.note IS NULL)
