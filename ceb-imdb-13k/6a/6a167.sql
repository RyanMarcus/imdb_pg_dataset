...
AND (mi1.info IN ('Greek','Hindi','Mandarin','Portuguese','Russian','Tagalog'))
AND (it1.id IN ('17','4','98'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('B6161','B6162','C6235','C6416','E4213','J5215','M6216','M6263','R3565') OR n.name_pcode_nf IS NULL)
AND (ci.note IS NULL)
