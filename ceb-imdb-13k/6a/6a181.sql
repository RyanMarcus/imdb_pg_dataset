...
AND (mi1.info IN ('Adult','Adventure','Biography','Fantasy','History','Musical','Sport','War'))
AND (it1.id IN ('103','15','3'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('f','m'))
AND (n.name_pcode_nf in ('A5365','D1312','J1625','J5214','J5215','M2424','M6246','S2524','T52','V2362','V2365','W4361'))
AND (ci.note IS NULL)
