...
AND (mi1.info IN ('Family','Germany','Mexico','Philippines','Spain','Thriller','Turkey','War','West Germany','Western'))
AND (it1.id IN ('3','8'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('m'))
AND (n.name_pcode_nf in ('C6421','C6423','C6424','F6524','R1631','R2632','V4356','W4362'))
