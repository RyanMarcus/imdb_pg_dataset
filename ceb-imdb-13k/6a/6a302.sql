...
AND (mi1.info IN ('Action','Animation','Comedy','Documentary','Drama','Family','Horror','Romance','Short'))
AND (it1.id IN ('110','3'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('m'))
AND (n.name_pcode_nf in ('A2352','B5251','D1353','D1634','J5253','J535','J562','J6241','M3252','P362','S525'))
