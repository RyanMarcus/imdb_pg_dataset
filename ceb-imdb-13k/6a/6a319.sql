...
AND (mi1.info IN ('English','Filipino','French','Japanese','Spanish'))
AND (it1.id IN ('4','94'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('f','m'))
AND (n.name_pcode_nf in ('A5242','D1324','D1352','D5216','D5432','G6352','J5162','J5243','M2453','P3625','S3541','W4516'))
AND (ci.note IS NULL)
