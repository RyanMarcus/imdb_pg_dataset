...
AND (mi1.info IN ('Dutch','English','French','German','Hindi','Italian','Japanese','Portuguese','Russian','Spanish'))
AND (it1.id IN ('110','4'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('f'))
AND (n.name_pcode_nf in ('A4216','A4252','A52','C6451','C6453','J5126','J5215','M6216','M6523','S5361'))
AND (ci.note IS NULL)
