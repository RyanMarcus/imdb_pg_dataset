...
AND (mi1.info IN ('Canada','Denmark','Mexico','Philippines','Soviet Union','Turkey','West Germany','Yugoslavia'))
AND (it1.id IN ('16','8'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A4163','A5352','A5362','C6423','F6521','F6524','F6525','R1631','R1632') OR n.name_pcode_nf IS NULL)
