...
AND (mi1.info IN ('10','12','13','15','20','3','30','4','5','6','7','8','9','90','USA:60'))
AND (it1.id IN ('1','102','107'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('C6235','C6521','D5242','F6524','K6524','M2425','M2456','S5162','S53','V6412'))
