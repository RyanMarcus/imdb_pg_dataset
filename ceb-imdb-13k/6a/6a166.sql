...
AND (mi1.info IN ('OFM:Live','PCS:Spherical','PFM:35 mm','PFM:Video','RAT:1.33 : 1','RAT:1.37 : 1','RAT:2.35 : 1'))
AND (it1.id IN ('18','7'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A4236','A6361','A6362','J5235','J5243','M2415','M2423','M4245','M6216','M6252','M6354','S3151'))
AND (ci.note IS NULL)
