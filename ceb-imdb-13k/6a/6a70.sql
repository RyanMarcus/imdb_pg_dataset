...
AND (mi1.info IN ('English','Filipino','French','German','Italian','Japanese','Spanish'))
AND (it1.id IN ('13','4'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('m'))
AND (n.name_pcode_nf in ('A5362','B6563','C6424','C6425','E6523','H6163','J5235','J5265','R1631','R1634','R2636'))
AND (ci.note IS NULL)
