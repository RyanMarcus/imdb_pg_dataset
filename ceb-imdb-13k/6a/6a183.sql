...
AND (mi1.info IN ('Adventure','Biography','Crime','Fantasy','Romance','Sci-Fi','Sport','Thriller'))
AND (it1.id IN ('104','3','94'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A4253','A5352','B6535','F6521','F6525','R1631','R1632','R2632','S3152') OR n.name_pcode_nf IS NULL)
AND (ci.note IS NULL)
