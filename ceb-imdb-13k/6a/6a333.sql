...
AND (mi1.info IN ('Adventure','Biography','Fantasy','Musical','Mystery','Sci-Fi'))
AND (it1.id IN ('106','3','97'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A4253','A5361','C6231','J5362','R1632','R2632','S3152','S3162'))
