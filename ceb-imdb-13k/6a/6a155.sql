...
AND (mi1.info IN ('Crime','Family','Musical','Thriller','War','Western'))
AND (it1.id IN ('16','3','6'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A4163','A4253','A5352','A5362','E6523','F6521','M6263','R1632') OR n.name_pcode_nf IS NULL)
AND (ci.note IS NULL)
