...
AND (mi1.info IN ('Black and White','Color','OFM:35 mm','PCS:Spherical','PFM:35 mm','RAT:1.33 : 1'))
AND (it1.id IN ('2','7','94'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('f','m'))
AND (n.name_pcode_nf in ('A6362','B6563','C6426','E4213','F6362','F6523','F6524','F6526','R1635','R2632','S2534','V4356','W4362'))
