...
AND (mi1.info IN ('France','Germany','India','Italy','Japan','Mexico','UK','USA'))
AND (it1.id IN ('103','18','8'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('m'))
AND (n.name_pcode_nf in ('A4163','A4253','A5362','C6421','C6423','C6425','F6525','R1631') OR n.name_pcode_nf IS NULL)
