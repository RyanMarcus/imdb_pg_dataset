...
AND (mi1.info IN ('Arabic','Dutch','English','French','German','Hindi','Italian','Japanese','Spanish','Swedish'))
...
AND (rt.role in ('actress','costume designer','director','producer','writer'))
