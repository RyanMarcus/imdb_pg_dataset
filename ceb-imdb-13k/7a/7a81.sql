...
AND (mi1.info IN ('Animation','Comedy','Crime','Documentary','Romance','Short','Western'))
AND (it1.id IN ('13','15','3'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A4163','A6362','E3632','F6362','F6523','F6526','F6532','G6216','H6163','R1635','R1636','R2632','S2534','V4356','W4362'))
