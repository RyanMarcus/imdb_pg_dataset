...
AND (mi1.info IN ('Animation','Color','Comedy','Documentary','Drama','Romance','Short'))
AND (it1.id IN ('2','3'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('m'))
AND (n.name_pcode_nf in ('A4163','A4253','A5352','F6521','F6525','R1632') OR n.name_pcode_nf IS NULL)
AND (ci.note IS NULL)
