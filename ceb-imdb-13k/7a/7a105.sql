...
AND (mi1.info IN ('Australia:MA','Canada:PG','France:U','Germany:16','Iceland:L','Netherlands:16','Netherlands:AL','USA:TV-PG','USA:Unrated','West Germany:16'))
AND (it1.id IN ('103','11','5'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('m'))
AND (n.name_pcode_nf in ('C6231','D5436','E6236','G6263','G6326','H2525','J153','J2545','P436','R3261','S3632'))
