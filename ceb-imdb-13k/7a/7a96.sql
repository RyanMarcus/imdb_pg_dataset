...
AND (mi1.info IN ('Action','Animation','Comedy','Crime','Documentary','Finland:K-16','Romance','Short','USA:Approved'))
AND (it1.id IN ('16','3','5'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('f','m'))
AND (n.name_pcode_nf in ('C6421','C6423','C6424','C6425','C6426','F6524','F6532','R1631','R2632','V4356'))
