...
AND (mi1.info IN ('Australia','Canada','France','India','Italy','Japan','UK','West Germany'))
AND (it1.id IN ('18','8'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A5242','A5356','A6361','B6165','D1324','D5216','J2425','K6235','M2424','M2453','M6216','M6241','M6354'))
AND (ci.note IS NULL)
