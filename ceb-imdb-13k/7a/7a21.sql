...
AND (mi1.info IN ('English','French','German','Italian','Mono','Spanish','Stereo'))
AND (it1.id IN ('4','6'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.gender in ('f','m'))
AND (n.name_pcode_nf in ('A5352','B6161','C6231','D1316','E3632','F6362','G6216','J5241','M2416','M2426','P3625','R1632','R2636','S3152'))
AND (ci.note IS NULL)
