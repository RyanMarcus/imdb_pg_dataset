...
AND (it1.id IN ('5'))
AND (mi1.info in ('Australia:M','Canada:PG','Iceland:L','Singapore:PG','USA:PG'))
AND (kt.kind in ('episode','movie'))
AND (rt.role in ('actor','actress','costume designer','producer'))
AND (n.gender in ('f','m'))
AND (n.surname_pcode in ('B6','B626','C45','G62','H4','H62','J52','J525','K4','R24','R5','W5') OR n.surname_pcode IS NULL)
